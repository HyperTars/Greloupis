    ...
    if type(e) == RouteError:
        if e.get_code() > 2002 and e.get_code() < 2004:
            return util_serializer_api_response(
                403, error_code=e.get_code(), msg=e.get_msg())

        return util_serializer_api_response(
            404, error_code=e.get_code(), msg=e.get_msg())
        ...
        if e.get_code() == 3004 or e.get_code() == 3011:
            ...
            return util_serializer_api_response(
                400, error_code=e.get_code(), msg=e.get_msg())
        ...
        if 4101 <= e.get_code() <= 4103:
            ...
            return util_serializer_api_response(
                500, error_code=e.get_code(), msg=e.get_msg())
